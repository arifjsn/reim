...
<script>
    ...
    function addRow() {
        ...
        cell1.innerHTML = '<input type="date" name="tanggal[]" value="{{ old('
        pengeluaran[]
        ') }}"/>';
        cell2.innerHTML = '<input type="text" name="deskripsi[]" value="{{ old('
        pengeluaran[]
        ') }}"/>';
        cell3.innerHTML = '<input type="number" name="pengeluaran[]" value="{{ old('
        pengeluaran[]
        ') }}" onkeyup="total();"/>';
    }
